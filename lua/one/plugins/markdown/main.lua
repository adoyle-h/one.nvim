local M = {
	...
	config = function(config)
		require('render-markdown').setup(config.renderMarkdown)
	end,
}
...
M.highlights = function(config)
	...
	return {
		RenderMarkdownH1Bg = { bg = colors.darkCyan },
		RenderMarkdownH2Bg = { bg = colors.darkBlue },
		RenderMarkdownH3Bg = { bg = colors.darkGreen },
		RenderMarkdownH4Bg = { bg = colors.darkOrange },
...
M.defaultConfig = { 'renderMarkdown', {
