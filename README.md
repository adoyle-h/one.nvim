...
<summary>Click to expend/collapse plugin list</summary>
  ...
  - LSP: [nvim-lspconfig](lua/one/plugins/lsp/main.lua) and [treesitter](lua/one/plugins/treesitter/init.lua) and [none-ls](lua/one/plugins/lsp/none-ls.lua) and [nlsp](lua/one/plugins/lsp/nlsp.lua) and [goto-preview](lua/one/plugins/lsp/preview.lua) and [lsp-toggle](https://github.com/adoyle-h/lsp-toggle.nvim)
  - DAP: [nvim-dap](lua/one/plugins/dap/init.lua)
  - Format: [conform.nvim](./lua/one/plugins/format/conform.lua) and [editorconfig-vim](https://github.com/editorconfig/editorconfig-vim)
